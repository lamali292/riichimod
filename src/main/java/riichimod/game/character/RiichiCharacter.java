package riichimod.game.character;
...
import riichimod.game.cards.*;

import java.util.ArrayList;

import static riichimod.RiichiMod.makeID;
import static riichimod.RiichiMod.characterPath;

public class RiichiCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Riichi"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass RIICHI;
        @SpireEnum(name = "RIICHI_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "RIICHI_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new RiichiCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public RiichiCharacter() {
        super(getNames()[0], Meta.RIICHI,
