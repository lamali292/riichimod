...
import riichimod.RiichiMod;
import riichimod.game.util.CardStats;
import riichimod.game.util.TriFunction;
...
import static riichimod.game.util.GeneralUtils.removePrefix;
import static riichimod.game.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return RiichiMod.makeID(name); }
